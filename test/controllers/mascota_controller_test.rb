...
class MascotaControllerTest < ActionController::TestCase
  ...
  test "should create mascotum" do
    assert_difference('Mascotum.count') do
      post :create, mascotum: { edad: @mascotum.edad, inscrito: @mascotum.inscrito, nChip: @mascotum.nChip, raza: @mascotum.raza, tipo: @mascotum.tipo }
    end
  ...
  test "should update mascotum" do
    patch :update, id: @mascotum, mascotum: { edad: @mascotum.edad, inscrito: @mascotum.inscrito, nChip: @mascotum.nChip, raza: @mascotum.raza, tipo: @mascotum.tipo }
    assert_redirected_to mascotum_path(assigns(:mascotum))
  end

...
class InmueblesControllerTest < ActionController::TestCase
  ...
  test "should create inmueble" do
    assert_difference('Inmueble.count') do
      post :create, inmueble: { calle: @inmueble.calle, ciudad: @inmueble.ciudad, comuna: @inmueble.comuna, numero: @inmueble.numero }
    end
  ...
  test "should update inmueble" do
    patch :update, id: @inmueble, inmueble: { calle: @inmueble.calle, ciudad: @inmueble.ciudad, comuna: @inmueble.comuna, numero: @inmueble.numero }
    assert_redirected_to inmueble_path(assigns(:inmueble))
  end

...
RSpec.describe "producto_personas/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit producto_persona form" do
    render

    assert_select "form[action=?][method=?]", producto_persona_path(@producto_persona), "post" do

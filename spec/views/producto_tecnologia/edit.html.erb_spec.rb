...
RSpec.describe "producto_tecnologia/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit producto_tecnologium form" do
    render

    assert_select "form[action=?][method=?]", producto_tecnologium_path(@producto_tecnologium), "post" do

...
RSpec.describe "producto_vehiculos/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit producto_vehiculo form" do
    render

    assert_select "form[action=?][method=?]", producto_vehiculo_path(@producto_vehiculo), "post" do

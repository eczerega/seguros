...
RSpec.describe "producto_inmuebles/new", type: :view do
  before(:each) do
    assign(:producto_inmueble, ProductoInmueble.new(
      :producto => "MyString",
  ...
  it "renders new producto_inmueble form" do
    render

    assert_select "form[action=?][method=?]", producto_inmuebles_path, "post" do
